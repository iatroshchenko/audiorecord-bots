...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    createRecord: function createRecord() {
      ...
      var fd = new FormData();
      Object.keys(this.record).forEach(function (key) {
        if (_typeof(_this3.record[key]) === 'object') {
          fd.append(key, JSON.stringify(_this3.record[key]));
        } else {
          fd.append(key, _this3.record[key]);
        }
      });
      fd.append('file', this.$refs.recordFile.files[0] || null);
      return axios__WEBPACK_IMPORTED_MODULE_2___default().post('/internal/records', _objectSpread({}, fd));
    },

    /* Upload */
    uploadTagFromInput: function uploadTagFromInput(name) {
      return axios__WEBPACK_IMPORTED_MODULE_2___default().post('/internal/tags', {
        name: name
      });
    },
    ...
    loadTags: function loadTags() {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_2___default().get('/internal/tags').then(function (res) {
        _this4.tags = _toConsumableArray(res.data.data);
      })["catch"](function (err) {
        console.log(err);
      });
    }
                  ...
                  _c("div", { staticClass: "-mx-3 mb-6" }, [
                    ...
                    _c("div", { staticClass: "px-3 mb-6 md:mb-0" }, [
                      ...
                      _c("input", {
                        ...
                        attrs: { type: "file", id: "record-file" },
                        on: { change: _vm.onRecordFileUpload }
                      }),
                      _vm._v(" "),
                      _c("p", { staticClass: "text-red text-xs italic" }, [
                        _vm._v("The record itself")
                      ])
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "px-3 mb-6 md:mb-0" }, [
                ...
                [
                  _c(
                    "simple-button",
                    {
                      ...
                      on: { click: _vm.onUploadRecordClick }
                    },
                    [_vm._v("\n          Upload\n        ")]
                  ),
                  _vm._v(" "),
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "px-3 mb-6 md:mb-0" }, [
      _c(
        "label",
        {
          staticClass:
      ...
      _vm._v(" "),
      _c("p", { staticClass: "text-red text-xs italic" }, [
        _vm._v("The record will be available for search by this name.")
      ])
    ])
  }
]
